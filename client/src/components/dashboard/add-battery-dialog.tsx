...
//     mutationFn: async (data: any) => {
//       try {
//         // Ensure initialDate is a string in ISO format
//         let formattedInitialDate;
//         if (typeof data.initialDate === 'string') {
//           formattedInitialDate = data.initialDate;
//         } else if (data.initialDate instanceof Date) {
//           formattedInitialDate = data.initialDate.toISOString();
//         } else {
//           formattedInitialDate = new Date().toISOString();
//         }

//         // Format the data with properly formatted date strings
//         const formattedData = {
//           ...data,
  ...
  const mutation = useMutation({
    mutationFn: async (data: any) => {
      try {
        ...
        // Use the API_BASE_URL from apiConfig
        const url = `${API_BASE_URL}/api/batteries`;
