...
//         // Use relative URL path rather than full URL
//         const url = "/api/batteries";
...
//                       <FormControl>
//                         <Input placeholder="e.g., Vehicle #7, East Wing" {...field} className="bg-muted/30 border-border/50" />
//                       </FormControl>
//                       <FormMessage />
//                     </FormItem>
//                   )}
